package corviolis.kingdoms;

import arnaria.kingdoms.commands.*;
import corviolis.kingdoms.commands.*;
import corviolis.kingdoms.services.api.RestAPI;
import corviolis.kingdoms.services.claims.ClaimManager;
import corviolis.kingdoms.services.events.ChallengeManager;
import corviolis.kingdoms.util.Settings;
    ...
    public void onInitialize() {
        ...
        if (validConfig) {
            ...
            BlueMapAPI.onEnable(api -> {
                try {
                    blueMapAPI = api;
                    corviolis.kingdoms.services.api.BlueMapAPI.init(api.getMarkerAPI());
